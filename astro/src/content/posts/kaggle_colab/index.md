...
Colab can be mounted on Google Cloud Storage, allowing us to access Kaggle datasets _without downloading them_. To do so, you need some setups. First, authenticate your account by the following snippet:
