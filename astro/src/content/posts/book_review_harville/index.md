...
tags: ["book", "math"]
slug: "book_review_harville"
lang: "ja"
---

## はじめに

『[統計のための行列代数](https://amzn.to/3wwCCmQ)』（D. A. Harville 著，伊理正夫 監訳，丸善出版，2012年）を読んだので，まとめと感想を書きます．
...
ブロック対角行列などを定義するのに必要になる部分行列と分割行列を準備します．**主部分行列 (principal submatrix)** とその部分集合である**首座部分行列 (leading principal submatrix)** は忘れがちなので掲げておきます．
...
- 任意の正定値行列は非特異です．ただし，_逆は成り立ちません_．
