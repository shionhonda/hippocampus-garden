...
DR is unbiased when the DM model is well-specified _or_ the behavior policy is known. In this sense, this method is "doubly robust". Its variance is lower than IS.
