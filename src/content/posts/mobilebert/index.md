...
Empirical studies on GLUE benchmark and SQuAD dataset show that MobileBERT has _comparable performance to BERT-Base_ and outperforms other compressed models, while _its model size and latency are remarkably reduced_.
...
_ALBERT is smaller but far slower than MobileBERT!_
