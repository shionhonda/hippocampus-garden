...
tags: ["graph", "data-analysis"]

slug: "citation_network_analysis"
lang: "en"
---
...
In the last part, based on the results of Bollen _et al._, I consider _papers with many citations and low PageRank_. Here are the 10 most cited papers with a PageRank less than 3e-6:
...
In conclusion, when PageRank is applied as an objective index of papers, the result strongly correlates with the number of citations. However, there is also a difference corresponding to the trend in the journal that _IF indicates the popularity and JPR reflects the prestige_.
...
[2] Tang, Jie, et al. "[Arnetminer: extraction and mining of academic social networks](https://dl.acm.org/doi/abs/10.1145/1401890.1402008)." _Proceedings of the 14th ACM SIGKDD international conference on Knowledge discovery and data mining_. 2008.  
[3] Bollen, Johan, Marko A. Rodriquez, and Herbert Van de Sompel. "[Journal status](https://link.springer.com/article/10.1007/s11192-006-0176-z)." _Scientometrics_ 69.3 (2006): 669-687.
