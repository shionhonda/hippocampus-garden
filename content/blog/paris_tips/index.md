---
title: パリ移住に関連する便利情報
date: "2024-07-21T23:02:03.284Z"
description: "新天地で働き始めてもうすぐ1年になるので、所感をまとめました。"
featuredImage: paris_tips/ogp.jpg
tags: ["ja", "france", "career"]
---
昨年8月にパリでソフトウェアエンジニアとして新しい生活を始め、早くも1年が経過しました。フランスについてほとんど知識がないままの渡航には多くの不安が伴いましたが、振り返ってみると非常に充実した1年だったと感じています。渡航直後に書いた[就活体験記](https://hippocampus-garden.com/job_hunt_in_france/)は多くの反響をいただき、その後の生活についても多数の質問をいただきました。そこで、1年という節目を迎えた今、フランスでのエンジニア生活についての所感をまとめてみたいと思います。海外でのキャリアに関心のある方に、パリでの具体的な体験や洞察を共有できればと思います。

## テック業界概観

最初に前提知識として、フランスのテック業界について簡単に述べておきます。
...
日本とフランスの職場環境にはさまざまな相違点があります。まず、よく知られていることですが、フランスではプライベートの時間が重視されます。標準的には週35時間労働、年間5週間の有給休暇と定められており、月に何十時間も残業するというような話はあまり聞きません。7-8月のバカンスシーズンにはパリ市内が閑散とし、諸々のサービスが滞るほどです。また、私の会社ではあまり見かけませんが、昼休みを2時間とって一時帰宅するという人もいるそうです。ワークライフバランスに関する考え方は日本と根本的に異なり、そもそもフランスでそのような言葉を耳にしたことがありません。
...
ここまではフランス対日本という軸で話をしてきましたが、Alanには他のフランスのスタートアップとも違う特異な文化があります[^3]。例えば、管理職がいない、あらゆる社内情報（意思決定プロセスや人事評価なども含む）が社内の誰からでも参照できる、"keeper test"[^4]を実践している、口頭よりも書面でのコミュニケーションを好む、などです。これらが実際に絶妙な調和の上で機能しており、結果として効率的に大きな成果を出しやすい環境ができています。特に、文書化を徹底する文化は生成AI時代において一層有意義な投資だと思います。これには企業文化の潜在的なパワーを実感したので、いつか日本に帰国する際にはこれらの文化を持ち帰れればと考えています。
...
<div style="text-align: center;"><small>オフィスの屋上からの景色。天気がいい日にはここで昼食をとります</small></div>
...
<div style="text-align: center;"><small>近所の公園でよく見かけるインドガン（手前）とアフリカガチョウ（奥）のカップル</small></div>
